...
{
    ui->setupUi(this);
    ui->menuFile->setTitle( QString::fromLocal8Bit("Файл"));
    ui->actionRender->setText( QString::fromLocal8Bit("Отрисовать сцену"));
    ui->actionAbout->setText( QString::fromLocal8Bit("О программе"));
    ui->actionExit->setText( QString::fromLocal8Bit("Выход"));
...
{
    QMessageBox::information(this,  QString::fromLocal8Bit("О программе"),  QString::fromLocal8Bit("Отрисовщик примитивов \n © Большов Андрей"));
